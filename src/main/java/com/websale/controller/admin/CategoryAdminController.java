...
public class CategoryAdminController {
	...
	public String delete(Model model, RedirectAttributes params, @PathVariable("id") Integer id) {
		boolean hasOrders = categoryService.hasProductsWithOrders(id);
		if (hasOrders) {
			params.addAttribute("message", "Không thể xóa loại sản phẩm này vì đã có sản phẩm trong đơn hàng");
		} else {
