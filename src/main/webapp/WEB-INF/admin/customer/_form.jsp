				...
				<div class="col-sm-9">
					<div class="row">
						...
						<div class="form-group col-sm-6">
							...
							<form:password path="password" showPassword="true" required="required" class="form-control"/>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-sm-6">
						...
						<div class="form-group col-sm-6">
							...
							<form:input path="email" required="required" type="email" class="form-control"/>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-sm-6">
