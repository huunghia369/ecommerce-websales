...
<div class="panel panel-success">
		...
		<tbody>
			<c:forEach var="p" items="${cart.itemsCart}">
				<tr>
					<td>${p.id}</td>
					<td>${p.name}</td>
					<td><f:formatNumber value="${p.unitPrice}" pattern="#,###.00" /> đ</td>
	...
	<div class="panel-footer">Tổng giá : ${cart.amountCart} VNĐ</div>
</div>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<div class="row">
				...
				<div class="form-group col-sm-6">
					<label>Ghi chú</label>
					<form:textarea path="description" rows="3" class="form-control" placeholder="(Có thể cung cấp thêm thông tin cần thiết như: ngày nhận hàng,...)"/>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-sm-6">
